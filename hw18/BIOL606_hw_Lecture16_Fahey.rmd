...
bird.plot = ordiplot(
  ...
  main=paste0( # plot title
    'Stress = ', 
    round(bird.nmds$stress,dig=4) # add stress label to title
    ),
...
__Question:__ Based on your plot, describe which (if any) of the habitats 
differ in community composition


__Answer:__ Two of the habitats are clearly different from the others in the
NMDS ordination plot: _Box-Ironbank_ and _Red River Gum_. These points do not
overlap at all with any other habitat. The remaining habitats all overlap the
mixed group. 
