...
png(file="histograms.png", width=1200, height=700)
...
# improve.
png(file="N-transformation.png", width=600, height=350)
soil$N.sqrt = sqrt(soil$N)
hist.data.frame(soil[c('N', 'N.sqrt')], nclass=10)
dev.off()

png(file="Dens-transformation.png", width=600, height=350)
soil$Dens.log = log(soil$Dens)
hist.data.frame(soil[c('Dens', 'Dens.log')], nclass=10)
dev.off()

png(file="P-transformation.png", width=600, height=350)
...
png(file="stress-per-dim.png", width=1200, height=700)
